    ...
    )
{
    ...
    else
    {
        ...
        writeln( "    PrintScriptArguments" );
        writeln( "    PrintFunctionArguments" );
        writeln( "    PrintScriptVariables" );
        writeln( "    PrintFileVariables" );
        ...
        writeln( "    PullMarks" );
        writeln( "    PopMarks" );
        writeln( "    Set variable_name assignment_operator variable_value" );
        writeln( "    Go label" );
        writeln( "    Repeat label [count]" );
        writeln( "    Call label {arguments}" );
        writeln( "    Return" );
        writeln( "    Exit" );
        writeln( "    Include script_file_path" );
        writeln( "    Execute script_file_path {arguments}" );
        writeln( "    Do command {arguments}" );
        writeln( "Examples :" );
